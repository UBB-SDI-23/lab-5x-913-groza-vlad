            ...
            <Card>
				<CardContent>
                    ...
                    <Container sx={{display: "flex", flexDirection: "column", justifyContent: "space-evenly", alignContent: "center"}}>
                        ...
                        <ul>
                            <li>Football Clubs: {user?.entities_added[0]}</li>
                            <li>Football Players: {user?.entities_added[1]}</li>
                            <li>Competitions: {user?.entities_added[2]}</li>
                            <li>Records: {user?.entities_added[3]}</li>
                        </ul>
                    </Container>
